...
namespace AiWonderTest
{
   public class BloomComponent : DrawableGameComponent
   {
      ...
      protected override void LoadContent()
      {
         ...
         bloomExtractEffect = Game.Content.Load<Effect>("Shader\\BloomExtract");
         bloomCombineEffect = Game.Content.Load<Effect>("Shader\\BloomCombine");
         gaussianBlurEffect = Game.Content.Load<Effect>("Shader\\GaussianBlur");

         testShader = Game.Content.Load<Effect>("Shader\\testShader");
         testShader.CurrentTechnique = testShader.Techniques["Show_Texcoord"];
         bubbleShader = Game.Content.Load<Effect>("Shader\\BubbleShader");
         bubbleShader.CurrentTechnique = bubbleShader.Techniques["TransformTechnique"];
